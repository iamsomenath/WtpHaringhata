...
class RawWaterFragment : Fragment() {
    ...
    lateinit var raw_text: TextView
    ...
    override fun onCreateView(
        ...
        raw_text = myView.findViewById(R.id.raw_text)

        if (activity!!.intent.hasExtra("CDATE")) {
            raw_text.text = (activity!!.intent.getSerializableExtra("VAL") as WTP_Pojo).rawWaterSource
    ...
    private fun saveRaw(rowTable: RowTable) {
        ...
        class SaveTask : AsyncTask<Void, Void, Void>() {
            ...
            override fun onPostExecute(aVoid: Void?) {
                ...
                Toast.makeText((activity as MainActivity), "Raw Water Data saved successfully", Toast.LENGTH_LONG).show()
